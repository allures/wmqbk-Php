...
<?php include "head.php";?>
  <div id="content">
    <div id="main" style="background:#fff;padding:15px;box-sizing:border-box;">      
	 <div class="ef"><input class="input_narrow" size="40" name="tit" id="tit" value="<?php echo @$vv['title']; ?>" placeholder="标题 (可为空)" type="text">	  </div>
	 <?php if($act ==='edit'){?>
	 ...
	 <div class="ef"><div name="log" rows="12" id="log"><?php echo @$vv['content']; ?></div>
	 ...
	 <input id="upload-input" type="file" accept="image/*" onchange="showImg(this)" />
	  ...
	  <input name="pic" id="pic" type="hidden" value="<?php echo @$vv['pic'];?>" /> 
